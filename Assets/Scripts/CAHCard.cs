...
[CreateAssetMenu(fileName = "New CAHCard", menuName = "CAHCard")]
public class CAHCard : ScriptableObject
{
    ...
    public static CAHCard newBlackCard()
    {
        CAHCard newCard = new CAHCard();
        newCard.cardType = CardType.Black;
        newCard.content = blackList[Random.Range(0, blackList.Length)];

        return newCard;
    }

    public static CAHCard newWhiteCard()
    {
        CAHCard newCard = new CAHCard();
        newCard.cardType = CardType.White;
        newCard.content = whiteList[Random.Range(0, whiteList.Length)];
